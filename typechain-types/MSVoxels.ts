...
export interface MSVoxelsInterface extends utils.Interface {
  contractName: "MSVoxels";
  functions: {
...
export interface MSVoxels extends BaseContract {
  contractName: "MSVoxels";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MSVoxelsInterface;
