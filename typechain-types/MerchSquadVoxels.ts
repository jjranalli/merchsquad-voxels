...
export interface MerchSquadVoxelsInterface extends utils.Interface {
  contractName: "MerchSquadVoxels";
  functions: {
...
export interface MerchSquadVoxels extends BaseContract {
  contractName: "MerchSquadVoxels";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MerchSquadVoxelsInterface;
